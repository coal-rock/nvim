...
-- Remap to redo to something actually sane
...
-- Stop search highlight after pressing escape in normal mode
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ss', require('telescope.builtin').lsp_document_symbols, 'Search [S]ymbols')
  nmap('<leader>sS', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Search Workspace [S]ymbols')
